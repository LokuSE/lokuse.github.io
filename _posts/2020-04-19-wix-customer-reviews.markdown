...
>`Q:` Is it suitable for building a food ordering website?
...
>`Q:` Would wix be an option for a hobby photographer wanting to have private site for sharing photos with friends and family. Ie not discoverable and photos viewable by invitation only? Do their security settings allow for this?
...
>`Q:` We are a non-profit looking to build a crowdfunding platform. What are the pros and cons for using WIX?
...
>`Q:`  I could really use some answers to a few questions: Does Wix allow to export the email addresses for use with MailChimp or other platforms? Is it possible to create 2 websites? I would need an online shop and a simple presentation website within different categories.
...
>`Q:` I need to give someone access to my CPanel and my password for my Wix site. So far, customer service has not been able to help and they keep telling me "CName" info. Do I have access to that or is this something that Wix keeps on lockdown?
...
>`Q:` If I signed up for Wix plan and receive a free domain for one year, is the domain mine or does Wix retain ownership to it if I do something else after a year? 
...
>`Q:` I have a question. I’m undecided between Weebly and Wix, and it’s because the storage on both paid plans. I’m planning to do a website for a non profit and I have lots of videos, photos and files to put on it and my concern is the limited space that Wix offers, just 10 GB in this case. Can you help me to figure out a solution to this issue? 
...
>`Q:` just curious, is it better if I use wix to get my domain from them or to get it on my own from maybe Go daddy? or whoever you recommend? If I get through wix and one day I leave them and host site elsewhere will I be able to use my domain? so will they own it or will I??
...
>`Q:` Thanks for this great review. One thing I'm concerned about is the cost of email hosting through Wix. It adds another $4+ per email address. That seems pretty expensive. Do you know of any cheaper alternatives? That adds almost $150/yr to the cost of hosting.
...
>`Q:` I have tried wix more than once,but I always struggle building the site, for example I was finally able to create a gallery but I was unable to load any photos, since I'm not to savy, by paying for VIP subscription will someone be able to help me to build my site
...
>`Q:` Is it possible to make a transfer of my WIX website to my host ?
...
>`Q:` E-commerce Premium plan comes with debit card payment ?
...
>`Q:` I just opened my website with wix using a premium plan. I just had one query will I be able to take Booking for holiday stays as an agent on wix? Will it help me boost my site and reach out to a lot of people ?
...
>`Q:` I am doing a school project and would love some insight of why someone should choose Wix instead of another builder such as Weebly. Any insight would help!
...
>`Q:` Please tell if I can import themes from sites like themeforest.net and use in making own website on wix.com. Thanx.
...
>`Q:` Tell me something please, after i make a website on wix under free plan, can I take the code and database to another hosting site like siteground.com etc? ((I think as per your reviews the answer is No.)) Is the export functionality given in any paid plan or another free website builder, like weebly maybe? What all can be exported exactly?
...
>`Q:` I tend to research the heck out of everything. I was leaning towards Wix when I discovered it does not have responsive design. That's kind of a big issue in today's mobile world, no? My target market tends to be fairly mobile so I'm concerned about this aspect of Wix. thoughts please?
...
>`Q:` My ultimate question: is a wix-website, made on a desk top computer, moblie friendly by itself?? Or should a make some adjustments before?
